...
import { t as areasQuery } from "./queries-De83JLO2.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/areas-BvhtOQ7l.js
				...
				children: [
					...
					a.highlights && a.highlights.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
						...
						children: a.highlights.map((h) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "size-4 text-gold mt-1.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: h })]
						}, h))
					})
				]
			})]
