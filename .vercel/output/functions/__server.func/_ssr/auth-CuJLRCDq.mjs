...
//#region node_modules/.nitro/vite/services/ssr/assets/auth-CuJLRCDq.js
...
function AuthPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "min-h-screen flex items-center justify-center bg-primary-green px-6 py-20",
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "flex h-12 w-12 items-center justify-center bg-primary-green text-accent-green font-display text-xl font-bold",
								children: "C"
							})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
							className: "font-display text-3xl text-primary-heading-text",
