...
import { t as PropertyCard } from "./PropertyCard-Co3RKlI9.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-D0PY2Kyu.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: slides.map((s, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-gradient-to-r from-primary-green/85 via-primary-green/55 to-transparent" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-gradient-to-t from-primary-green/60 via-transparent to-transparent" })
					]
				}, s.id))
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						current.eyebrow && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "block h-px w-12 bg-accent-green" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-accent-green font-semibold tracking-[0.28em] uppercase text-[11px]",
			...
			total > 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: slides.map((s, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						onClick: () => setActive(i),
						className: `h-px transition-all duration-500 ${i === active ? "bg-accent-green w-12" : "bg-white/40 w-6 hover:bg-white/70"}`,
			...
			children: items.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Quote, {
						className: "size-8 text-accent-green/70 mb-6",
						strokeWidth: 1.5
					}),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [t.avatar_url && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
							...
							className: "text-[10px] uppercase tracking-[0.2em] text-accent-green/80 mt-0.5",
...
function HomePage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(s.icon && ICONS[s.icon] || MapPin, {
										className: "size-7 text-accent-green",
										strokeWidth: 1.5
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										className: "font-display text-2xl text-primary-green/15 group-hover:text-white/20 transition-colors",
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading, {
					...
					children: PROCESS_STEPS.map((s, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: `relative p-8 lg:p-10 bg-beige-bg border-b-4 ${i === 0 ? "border-accent-green" : "border-primary-green"} group hover:-translate-y-1 transition-transform duration-300`,
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-display text-5xl text-primary-green/15 mb-6 block",
								children: s.num
							}),
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			className: "section-padding bg-primary-green text-white",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "container-wide",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: WHY_CHOOSE.map((w) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "font-display text-5xl md:text-6xl text-primary-green mb-2",
					children: w.stat
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: areas.slice(0, 6).map((a) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-gradient-to-t from-primary-green/70 via-primary-green/10 to-transparent" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: blog.slice(0, 2).map((post) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
								className: "font-display text-2xl md:text-3xl text-primary-heading-text group-hover:text-accent-green transition-colors mb-3",
								children: post.title
							}),
