...
import { r as blogQuery } from "./queries-C5ESjNyL.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/blog.index-C9PlPcAf.js
			...
			children: posts.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "font-display text-2xl text-primary-heading-text group-hover:text-accent-green transition-colors mb-2",
						children: p.title
					}),
