...
import { t as Route$16 } from "./blog._slug-h7vrlIS4.mjs";
import { t as Route$17 } from "./properties._slug-CA61cgCU.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-BabMqTq4.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-CDG6DKIt.css";
var NAV_LINKS = [
	{
		to: "/",
		label: "Home"
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: `flex h-9 w-9 items-center justify-center font-display text-lg font-bold transition-colors ${scrolled ? "bg-primary-green text-accent-green" : "bg-white/95 text-primary-green"}`,
						children: "C"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						className: `font-display text-xl font-bold tracking-tight transition-colors ${scrolled ? "text-primary-heading-text" : "text-white"}`,
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
					...
					children: NAV_LINKS.map((l) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						to: l.to,
						className: `text-[11px] font-semibold uppercase tracking-[0.18em] transition-colors ${scrolled ? "text-primary-heading-text/70 hover:text-primary-heading-text" : "text-white/80 hover:text-white"}`,
						activeProps: { className: `text-[11px] font-semibold uppercase tracking-[0.18em] ${scrolled ? "text-primary-heading-text" : "text-white"}` },
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						to: "/contact",
						className: `hidden lg:inline-flex px-6 py-3 text-[11px] font-bold uppercase tracking-[0.18em] transition-all ${scrolled ? "bg-primary-green text-white hover:bg-dark-hover-green hover:text-white" : "bg-accent-green text-white hover:bg-white hover:text-primary-green"}`,
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "flex h-7 w-7 items-center justify-center bg-accent-green text-white font-display font-bold",
								children: "C"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					className: "font-display text-5xl text-primary-heading-text mb-3",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					className: "font-display text-4xl text-primary-heading-text mb-3",
...
var $$splitComponentImporter$13 = () => import("./services-CLfCoERG.mjs");
...
var $$splitComponentImporter$11 = () => import("./gallery-BSxebtBM.mjs");
...
var $$splitComponentImporter$10 = () => import("./faq-CAWyU3oF.mjs");
...
var $$splitComponentImporter$9 = () => import("./contact-C3XyEg3K.mjs");
...
var $$splitComponentImporter$7 = () => import("./auth-CuJLRCDq.mjs");
...
var $$splitComponentImporter$6 = () => import("./areas-B9h0xifR.mjs");
...
var $$splitComponentImporter$5 = () => import("./about-m4rN0O1j.mjs");
...
var $$splitComponentImporter$3 = () => import("./routes-D0PY2Kyu.mjs");
...
var $$splitComponentImporter$2 = () => import("./properties.index-C9SzOl5l.mjs");
...
var $$splitComponentImporter$1 = () => import("./blog.index-C9PlPcAf.mjs");
...
var $$splitComponentImporter = () => import("./admin-Dx4I7gL2.mjs");
