...
import { u as servicesQuery } from "./queries-C5ESjNyL.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/services-CLfCoERG.js
...
function ServicesPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			className: "pt-40 pb-20 bg-primary-green text-white",
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(s.icon && ICONS[s.icon] || MapPin, {
									...
									className: "font-display text-3xl text-primary-green/15",
									children: ["0", i + 1]
								})]
							}),
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			className: "section-padding bg-beige-bg text-center",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "container-wide",
