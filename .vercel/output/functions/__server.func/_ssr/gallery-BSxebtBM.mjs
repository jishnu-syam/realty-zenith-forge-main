...
//#region node_modules/.nitro/vite/services/ssr/assets/gallery-BSxebtBM.js
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: images.map((img, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("figure", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
					...
					className: "absolute inset-x-0 bottom-0 bg-gradient-to-t from-primary-green/80 to-transparent p-5 text-xs uppercase tracking-[0.18em] text-white opacity-0 group-hover:opacity-100 transition-opacity",
