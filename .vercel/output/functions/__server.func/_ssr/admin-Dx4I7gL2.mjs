...
//#region node_modules/.nitro/vite/services/ssr/assets/admin-Dx4I7gL2.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				className: "font-display text-2xl text-primary-heading-text",
				children: title
...
function EditorDrawer({ row, fields, onClose, onSave, saving }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "absolute inset-0 bg-primary-green/40",
			onClick: onClose
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function AdminPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "min-h-screen bg-beige-bg flex",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
			className: "w-72 bg-primary-green text-white p-8 sticky top-0 self-start h-screen overflow-y-auto",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					to: "/",
					className: "flex items-center gap-2 mb-12",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "flex h-9 w-9 items-center justify-center bg-accent-green text-white font-display text-lg font-bold",
						children: "C"
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "eyebrow text-accent-green mb-6",
					children: "Content"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
					...
					children: SECTIONS.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						className: `w-full text-left px-4 py-2.5 text-sm transition-colors ${section === s.id ? "bg-white/10 text-accent-green" : "text-white/70 hover:text-white hover:bg-white/5"}`,
						children: s.label
					}, s.id))
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [!hasRole && !roles.isLoading && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mb-8 p-5 bg-accent-green/10 border border-accent-green/30 flex gap-3 items-start",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldAlert, { className: "size-5 text-accent-green shrink-0 mt-0.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "text-sm",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "font-bold text-primary-heading-text mb-1",
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", {
								className: "bg-beige-bg px-1.5 py-0.5",
								children: "user_roles"
							}),
							" table."
						]
