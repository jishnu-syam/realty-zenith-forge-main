...
//#region node_modules/.nitro/vite/services/ssr/assets/faq-CAWyU3oF.js
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Accordion, {
			...
			children: faqs.map((f) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AccordionItem, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AccordionTrigger, {
					className: "px-6 py-5 text-left font-display text-lg hover:no-underline hover:text-accent-green",
					children: f.question
